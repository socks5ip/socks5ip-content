...
> **收录平台 23 家｜文章 163+ 篇**（注册 23 + 工具 6 + 指南 105 + 对比 7 + FAQ 12 + 英文 10，持续扩充中）
...
| 平台 | 起价 | 协议 | 邀请码 | 官方注册链接 |
|---|---|---|---|---|
| [无双海外IP](articles/register/wushuangip.md) | 7.5 元/月 | SOCKS5/L2TP/SS | `nBhBjh3kGW39` | [注册](https://new.6nn.net/admin#/login?scope=register&inviteCode=nBhBjh3kGW39) |
| [全球代理IP](articles/register/quanqiuip.md) | 5 元/月 | SOCKS5/L2TP/HTTP/SS | 直接注册 | [注册](https://socks5ip.6nn.net/register) |
| [55游海外IP](articles/register/55you.md) | 0.6 元/天起 | SOCKS5/HTTP/L2TP | `adminA1` | [注册](https://55u.net/#/login?c=adminA1) |
| [CROWN皇冠IP](articles/register/crown.md) | 18 元/月 | SOCKS5/L2TP/HTTP | `adminA1` | [注册](http://www.ipcrown.com/register?invitation=adminA1&shareid=78) |

### 国内 IP 平台 · 推荐（7）

| 平台 | 起价 | 协议 | 邀请码 | 官方注册链接 |
|---|---|---|---|---|
| [奔富IP](articles/register/benfuip.md) | 2.6 元/月 | SOCKS5/L2TP/HTTP | `adminA1` | [注册](https://user.benfuip.com/main/register?aff=adminA1) |
...
| [百兆王](articles/register/baizhaowang.md) | 5 元/月 | SOCKS5 | `35ef6002...` | [注册](http://www.baizhaowang.com/?code=35ef60024d076d72) |
| [长城IP](articles/register/changchengip.md) | 5 元/月 | SOCKS5/L2TP | `FS5ErERm` | [注册](http://user.ccpptp.com/register?invitation_code=FS5ErERm) |

## 自研免费工具（6）

| 工具 | 说明 | 地址 |
|---|---|---|
| [IP综合检测中心](articles/tools/ip-check-center.md) | 4 款工具聚合：质量/线路/测速/业务模拟 | https://socks5ip.com.cn/ip-check-center/ |
| [IP质量检测](articles/tools/ip-check.md) | 归属地/住宅机房识别/黑名单 | https://socks5ip.com.cn/ip-check/ |
| [代理线路可用性检测](articles/tools/proxy-check.md) | 真实协议握手/延迟分级/批量检测 | https://socks5ip.com.cn/proxy-check/ |
| [网络测速](articles/tools/speedtest.md) | 下载上传/延迟/抖动/丢包 | https://socks5ip.com.cn/speedtest/ |
...
| [免费代理IP能不能用](articles/faq/mianfei-daili-fengxian.md) | 免费代理 3 风险 + 免费 vs 试用辨析 + 自测清单 | https://socks5ip.com.cn/ip-check-center/ |
...
- 全部平台支持**免费测试、先测后买**
- 价格口径为"X 元/月起"，实际以官方为准
- 结构化数据：`data/platforms.json`（平台清单）/ `data/tools.json`（工具清单）
...
- 2026-09-11：**滚动期指南 3 篇**（JiuIP三网选线/沧海八区对照/SOCKS5 vs HTTP）→ 内容仓累计 **118 篇**
